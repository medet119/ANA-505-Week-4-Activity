...
sum(students$Freq)
#TASK: Comment with the total (sum) here: ___

#Since we have a males dataset, let's make a females dataset
#TASK: replace the ? with the column name
females<-filter(students1, gender=="females")
